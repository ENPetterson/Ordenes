    ...
    <div>
        <form id="form">
            <table>
                ...
                <tr>
                    <td style="padding-right: 10px; padding-bottom: 10px">Opción:</td>
                    <td><div id="moneda"></div></td>
                </tr>
                <tr id="filaCable">
                    <td style="padding-right: 10px; padding-bottom: 10px">Prorrateo en cash:</td>
...
<script>
    $(function(){
        ...
        var monedas = [
            { value: '$', label: 'Compra por pesos'},
            { value: 'u$s', label: 'Canje PESA/PAMPA'}
        ];
        ...
        */
        ...
        if ($("#id").val() == 0){
         ...
         $('#form').jqxValidator({ rules: [
                ...
                { input: '#plazo', message: 'Debe elegir el plazo 2510!', action: 'change',  rule: function(){
                    var result;
