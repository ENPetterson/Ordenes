        ...
        <form id="form">
            <table>
                ...
                <tr id="filaPrecio">
                    ...
                    <td style="padding-right:10px; padding-bottom: 10px">Precio (u$s): </td>
...
<script>
    $(function(){
        ...
        */
        ...
        $("#precio").jqxNumberInput({ width: '110px', height: '25px', decimalDigits: 1, digits: 4, groupSeparator: ' ', max: 9999.9, theme: theme});
        ...
        */
        ...
        if ($("#id").val() == 0){
         ...
         $('#form').jqxValidator({ rules: [
                ...
                */
                /*
                { input: '#precio', message: 'El precio debe ser mayor que cero y expresado cada mil!', action: 'keyup, blur',  rule: function(){
                    if ($('#tramo').jqxDropDownList('getSelectedIndex') == 1 && ($("#precio").val() < 500 || $("#precio").val() > 1500)) {
                        return false;
                    } else {
                        return true;
                    }
