...
class Bono extends MY_AuthController {
    ...
    public function grilla(){
        ...
        $cierrebono_id = $this->input->post('cierrebono_id');
        
                
        $this->load->model('Bono_model');
        $this->Bono_model->usuario_id = $usuario_id;
        $this->Bono_model->cierrebono_id = $cierrebono_id;
    ...
    public function saveCierre(){
        ...
        //$this->Bono_model->minimos = $minimos;
        $this->Bono_model->especie = $this->input->post('especie');
        $this->Bono_model->colocacion = $this->input->post('colocacion');
        $this->Bono_model->tituloC = $this->input->post('tituloC');
        $this->Bono_model->tituloNC = $this->input->post('tituloNC');
        $cierre = $this->Bono_model->saveCierre();
        echo json_encode($cierre);
    }
    
    public function delCierre(){
        $cierrebono_id = $this->input->post('id');
        $this->load->model('Bono_model');
        $this->Bono_model->cierrebono_id = $cierrebono_id;
    ...
    public function cierreGrilla(){
        ...
        $table = "cierrebono";
        $fields = array('id','fechahora','especie');
