...
<script>
    $(function(){
        ...
        if ($("#id").val() == 0){
            ...
            datos = {
                cierregenerartxt_id: $("#id").val()
            };
            $.post('/generartxt/getCierre', datos, function(data){
        ...
        $('#aceptarButton').bind('click', function () {
            ...
            if (formOK){
                ...
                $.post('/generartxt/saveCierre', datos, function(data){
                    if (data.id > 0){
                        $.redirect('/generartxt/cierre');
                    } else {
