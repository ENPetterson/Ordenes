    ...
    $(document).ready(function () {
        ...
        {		
                ...
                columns: [
                        ...
                        { text: 'Fecha y Hora', datafield: 'fechahora', width: 350, cellsformat: 'dd/MM/yyyy HH:mm:ss'}
                ]
        });
        ...
        $("#nuevoButton").click(function(){
            $.redirect('/generartxt/cierreEditar', {'id': 0});
        });
        
        $("#editarButton").click(function(){
            $.redirect('/generartxt/cierreEditar', {'id': id});
        });
            ...
            new Messi('Desea borrar el cierre del ' + fechaCierre + ' ?' , {title: 'Confirmar',titleClass: 'warning', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        ...
                        $.post('/generartxt/delCierre', datos, function(data){
...
<div>
<div id="sistema" style='float: left; vertical-align: text-bottom; text-align: left;'><ul>Grilla Cierre Generar Txt</ul></div>
<br>
<br>
<div id="grilla"></div>
