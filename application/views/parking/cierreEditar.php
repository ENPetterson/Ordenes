...
//        $("#colocacionDolares").jqxNumberInput({ width: '250px', height: '25px', theme:theme, digits:6, decimalDigits: 0});
        ...
        */
        ...
        if ($("#id").val() == 0){
            $("#titulo").text('Nuevo Cierre Parking');
        } else {
            $("#titulo").text('Editar Cierre Parking');
            datos = {
                cierreparking_id: $("#id").val()
            };
            $.post('/parking/getCierre', datos, function(data){
...
//                    colocacionDolares: $("#colocacionDolares").val()
                ...
                $.post('/parking/saveCierre', datos, function(data){
                    if (data.id > 0){
                        $.redirect('/parking/cierre');
                    } else {
