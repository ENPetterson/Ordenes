<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#nuevoButton").click(function(){
            $.redirect('/parking/cierreEditar', {'id': 0});
        });
        
        $("#editarButton").click(function(){
            $.redirect('/parking/cierreEditar', {'id': id});
        });
            ...
            new Messi('Desea borrar el cierre del ' + fechaCierre + ' ?' , {title: 'Confirmar',titleClass: 'warning', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        ...
                        $.post('/parking/delCierre', datos, function(data){
...
<br>
<div id="sistema" style='float: left; vertical-align: text-bottom; text-align: left;'><ul>Grilla Cierre Parking</ul></div>
<br>
<br>
<div id="grilla"></div>
<br>
