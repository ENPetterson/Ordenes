...
//        $("#enviarMercadoButton").jqxButton({ width: '160', theme: theme, disabled: true });
        ...
        */
            ...
            new Messi('Desea aprobar las ordenes ' + enviar.join(', ') + ' ?' , {title: 'Confirmar',titleClass: 'warning', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        ...
                        $.post('/correccion/aprobarOrdenes', datos, function(data){
                            new Messi(data.resultado, {title: 'Mensaje', modal: true,
        ...
        $("#editarButton").click(function(){
            $.redirect('/correccion/editar', {'id': id, origen: 'aprobar'});
        });
...
<div id="cierre"></div>
<br>
<div id="sistema" style='float: left; vertical-align: text-bottom; text-align: left;'><ul>Autorizar Arreglo Boletos</ul></div>
<br>
<br>
<div id="grilla"></div>
<br>
