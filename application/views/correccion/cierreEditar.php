...
//        $("#colocacionDolares").jqxNumberInput({ width: '250px', height: '25px', theme:theme, digits:6, decimalDigits: 0});
        ...
        */
        ...
        if ($("#id").val() == 0){
            $("#titulo").text('Nuevo Cierre Correccion');
        } else {
            $("#titulo").text('Editar Cierre Correccion');
            datos = {
                cierrecorreccion_id: $("#id").val()
            };
            $.post('/correccion/getCierre', datos, function(data){
...
//                    colocacionDolares: $("#colocacionDolares").val()
                ...
                $.post('/correccion/saveCierre', datos, function(data){
                    if (data.id > 0){
                        $.redirect('/correccion/cierre');
                    } else {
