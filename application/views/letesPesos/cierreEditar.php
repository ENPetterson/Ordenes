        ...
        <form id="form">
            <table>
                ...
                <tr>
                    ...
                    <td><input type="text" id="instrumentoLetesPesos"></td>
                </tr>
                <tr>
...
<script>
    $(function(){
        ...
        $("#instrumentoLetesPesos").jqxInput({height: '20px', width: '190px', theme: theme});
        ...
        $('#form').jqxValidator({ rules: [
            ...
            { input: '#instrumentoLetesPesos', message: 'No existe un instrumento con ese nombre!',  rule: function(){
                ...
                $.post('/esco/existeInstrumento', {instrumento: $('#instrumentoLetesPesos').val()}, function(data){
        ...
        $('#aceptarButton').bind('click', function () {
            ...
            if (formOK){
                ...
                var datos = {
                    ...
                    instrumento: $("#instrumentoLetesPesos").val()
                };
                $.post('/letesPesos/saveCierre', datos, function(data){
                    if (data.id > 0){
                        $.redirect('/letesPesos/cierre');
                    } else {
