<script type="text/javascript">
    $(document).ready(function () {
        ...
        cache: false,
        url: '/canjelocaltardio/cierreGrilla',
        filter: function()
        {
        ...
        $("#grilla").on("bindingcomplete", function (event){
            ...
            $("#grilla").jqxGrid('localzestrings', localtardioizationobj);
        }); 
        ...
        $("#nuevoButton").click(function(){
            $.redirect('/canjelocaltardio/cierreEditar', {'id': 0});
        });
        
        $("#editarButton").click(function(){
            $.redirect('/canjelocaltardio/cierreEditar', {'id': id});
        });
            ...
            new Messi('Desea borrar el cierre del ' + fechaCierre + ' ?' , {title: 'Confirmar',titleClass: 'warning', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        ...
                        $.post('/canjelocaltardio/delCierre', datos, function(data){
...
<br>
<div id="sistema" style='float: left; vertical-align: text-bottom; text-align: left;'><ul>Grilla Cierre Canjelocaltardio</ul></div>
<br>
<br>
<div id="grilla"></div>
<br>
