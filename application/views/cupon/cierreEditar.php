...
<!--                <tr>
                    ...
                    <td><input type="text" id="instrumentoCupon"></td>
                </tr>-->
...
//        $("#instrumentoCupon").jqxInput({height: '20px', width: '190px', theme: theme});
...
//                $("#instrumentoCupon").val(data.instrumento);
            }, 'json');
        };
...
//            { input: '#instrumentoCupon', message: 'Debe ingresar el nombre del instrumento!',  rule: 'required' }
            /*
            { input: '#instrumentoCupon', message: 'No existe un instrumento con ese nombre!',  rule: function(){
                var resultado;
                jQuery.ajaxSetup({async:false});
                $.post('/esco/existeInstrumento', {instrumento: $('#instrumentoCupon').val()}, function(data){
...
//                    instrumento: $("#instrumentoCupon").val()
                };
