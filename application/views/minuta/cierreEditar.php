...
//        $("#colocacionDolares").jqxNumberInput({ width: '250px', height: '25px', theme:theme, digits:6, decimalDigits: 0});
        ...
        */
        ...
        if ($("#id").val() == 0){
            $("#titulo").text('Nuevo Cierre Minuta');
        } else {
            $("#titulo").text('Editar Cierre Minuta');
            datos = {
                cierreminuta_id: $("#id").val()
            };
            $.post('/minuta/getCierre', datos, function(data){
...
//                    colocacionDolares: $("#colocacionDolares").val()
                ...
                $.post('/minuta/saveCierre', datos, function(data){
                    if (data.id > 0){
                        $.redirect('/minuta/cierre');
                    } else {
