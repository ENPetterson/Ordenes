...
//        $("#sistema").jqxMenu({width: 200, height: 25, theme: theme});
        ...
        $("#nuevoButton").click(function(){
            $.redirect('/minuta/cierreEditar', {'id': 0});
        });
        
        $("#editarButton").click(function(){
            $.redirect('/minuta/cierreEditar', {'id': id});
        });
            ...
            new Messi('Desea borrar el cierre del ' + fechaCierre + ' ?' , {title: 'Confirmar',titleClass: 'warning', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        ...
                        $.post('/minuta/delCierre', datos, function(data){
...
<br>
<div id="sistema" style='float: left; vertical-align: text-bottom; text-align: left;'><ul>Grilla Cierre Minutas</ul></div>
<br>
<br>
<div id="grilla"></div>
<br>
