...
//                        { text: 'Comis', datafield: 'comision', width: 60, cellsalign: 'right', cellsformat: 'd4'},
                        ...
                        { text: 'Arancel', datafield: 'arancel', width: 140, cellsalign: 'right', cellsformat: 'd', aggregates: ['sum']},
...
//                        { text: 'Cant a Crec 2da', datafield: 'cantidadAcrecerSegunda', width: 140, cellsalign: 'right', cellsformat: 'd', aggregates: ['sum']},
                        ...
                        { text: 'usuario', datafield: 'usuario', hidden: true, width: 100},
        ...
        $("#nuevoButton").click(function(){
            $.redirect('/canje/editar', {'id': 0, origen: 'canje'});
        });
        
        $("#editarButton").click(function(){
            $.redirect('/canje/editar', {'id': id, origen: 'canje'});
        });
            ...
            new Messi('Desea borrar las ordenes ' + enviar.join(', ') + ' ?' , {title: 'Confirmar',titleClass: 'warning', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        ...
                        $.post('/canje/delOrden', datos, function(data){
...
////////////////////////////////////////////////////////////////////////////////   
        ...
        $('#archivoExcel').uploadifive({
            ...
            'onUploadComplete': function(file) {
                $('#grilla').ajaxloader();
                $.post('/canje/grabarExcel', { file: file.name, cierre: $("#cierre").jqxDropDownList('getSelectedItem').value}, function(msg){
                    var titleClass;
                    var mensaje;
                    var title;
                    if(msg.resultado == 'OK'){
...
<div id="cierre"></div>
<br>
<div id="sistema" style='float: left; vertical-align: text-bottom; text-align: left;'><ul>Grilla Canjees</ul></div>
<br>
<br>
<div id="grilla"></div>
<div id="botonera">
