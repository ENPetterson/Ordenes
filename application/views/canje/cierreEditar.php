...
<!--                <tr>
                    ...
                    <td><input type="text" id="instrumentoCanje"></td>
                </tr>-->
                <tr>
...
//        $("#instrumentoCanje").jqxInput({height: '20px', width: '190px', theme: theme});
...
//            { input: '#instrumentoCanje', message: 'Debe ingresar el nombre del instrumento!',  rule: 'required' }
            /*
            { input: '#instrumentoCanje', message: 'No existe un instrumento con ese nombre!',  rule: function(){
                var resultado;
                jQuery.ajaxSetup({async:false});
                $.post('/esco/existeInstrumento', {instrumento: $('#instrumentoCanje').val()}, function(data){
...
//                    instrumento: $("#instrumentoCanje").val()
                };
                $.post('/canje/saveCierre', datos, function(data){
                    if (data.id > 0){
                        $.redirect('/canje/cierre');
                    } else {
...
//            { value: 'u$s', label: 'Dolar'}
        ...
        $("#plazo").jqxNumberInput({ width: '300px', height: '20px', theme:theme, digits:4, groupSeparator: '', decimalDigits: 0});
