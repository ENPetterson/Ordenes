...
<div id="ventanaCanjelocal">
    <div id="titulo">
        Editar Orden Canjelocal
    </div>
    <div>
        <form id="form">
            <table>
...
<script>
    $(function(){
        ...
        $("#ventanaCanjelocal").jqxWindow({showCollapseButton: false, height: 500, width: 500, theme: theme, resizable: false, keyboardCloseKey: -1});
...
//                }, 'json');
        ...
        var srcPlazos = {
            ...
            data: {cierrecanjelocal_id: cierrecanjelocal_id},
            async: false,
            type: 'POST',
            id: 'id',
            url: '/canjelocal/getPlazosEspecies'
        }
...
//        $("#plazo").jqxDropDownList({ width: '110px', height: '25px', source: DAMonedas, theme: theme, placeHolder: 'elija plazo'});
        ...
        var srcBonos = {
            ...
            data: {
                    plazocanjelocal_id: $("#plazo").val()
                },
            async: false,
            type: 'POST',
            id: 'id',
            url: '/canjelocal/getPlazosBono'
        }
...
//        });
        ...
        function calcularPosicion(event){
            ...
            $.post('/canjelocal/getEspecie', { plazo: $("#plazo").val() }, function(data){
                especie = data;
...
//        }); 
        ...
        if ($("#id").val() == 0){
            $("#titulo").text('Nueva Orden Canjelocales');
            $("#filaCable").hide();
        } else {
            $("#titulo").text('Editar Orden Canjelocales');
            datos = {
                id: $("#id").val()
            };
            $.post('/canjelocal/getOrden', datos, function(data){
                cierrecanjelocal_id = data.cierrecanjelocal_id;
