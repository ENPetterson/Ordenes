<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#nuevoButton").click(function(){
            $.redirect('/licitacion/cierreEditar', {'id': 0});
        });
        
        $("#editarButton").click(function(){
            $.redirect('/licitacion/cierreEditar', {'id': id});
        });
            ...
            new Messi('Desea borrar el cierre del ' + fechaCierre + ' ?' , {title: 'Confirmar',titleClass: 'warning', modal: true,
                buttons: [{id: 0, label: 'Si', val: 's'}, {id: 1, label: 'No', val: 'n'}], callback: function(val) { 
                    if (val == 's'){
                        ...
                        $.post('/licitacion/delCierre', datos, function(data){
...
<div>
<div id="sistema" style='float: left; vertical-align: text-bottom; text-align: left;'><ul>Grilla Cierre Licitación</ul></div>
<br>
<br>
<div id="grilla"></div>
