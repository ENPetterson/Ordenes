...
//        var cierre_id = 0;
        var minimos = [];
        var minimo = 0;
        var cierrelicitacion_id = 0;
        
        $("#filaPrecio").hide();
        
        $("#ventanaLicitacion").jqxWindow({showCollapseButton: false, height: 500, width: 470, theme: theme, resizable: false, keyboardCloseKey: -1});
...
//        $("#tipoInversor").jqxDropDownList({ width: '300px', height: '25px', source: tipoInversor, theme: theme, placeHolder: 'elija el tipo de inversor'});
        ...
        var srcPlazos = {
            ...
            data: {cierrelicitacion_id: cierrelicitacion_id},
            async: false,
            type: 'POST',
            id: 'id',
            url: '/licitacion/getPlazosEspecies'
        }
...
//               elPlazo = 
        ...
        */
        ...
        if ($("#id").val() == 0){
            $("#titulo").text('Nueva Orden Licitación');
            $("#filaCable").hide();
            
             
            var url = '/licitacion/getCierreActual';
...
//                minimos = cierre.minimos.split(",");
            ...
            $.post('/licitacion/getOrden', datos, function(data){
                cierrelicitacion_id = data.cierrelicitacion_id;
...
//                $("#tipoInversor").val(data.tipoInversor);
                ...
                var datos = {cierrelicitacion_id: cierrelicitacion_id};
                url = '/licitacion/getCierre';
