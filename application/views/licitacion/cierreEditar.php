    ...
    <div>
        <form id="formPlazo">
            <table class="tabla-formulario">
                ...
                <tr>
                    <td>Colocacion Competitiva:</td>
                    <td><div id="colocacionC"></div></td>
                </tr>
                <tr>
                    <td>Colocacion No Competitiva:</td>
                    <td><div id="colocacionNC"></div></td>
                </tr>
                <tr>
    ...
    $(function(){
        ...
        $("#grillaPlazos").jqxGrid( {		
                ...
                columns: [
                    ...
                    { text: 'Colocacion C', datafield: 'colocacionC', width: 0, hidden: true },
                    { text: 'Colocacion NC', datafield: 'colocacionNC', width: 0, hidden: true },
        ...
        if ($("#id").val() == 0){
            ...
            datos = {
                cierrelicitacion_id: $("#id").val()
            };
            $.post('/licitacion/getCierre', datos, function(data){
            ...
            if (formOK){
                ...
                $.each(rowsPlazos, function(key, filaPlazo){
                    ...
                    var itemPlazo = {
                        ...
                        colocacionC: filaPlazo.colocacionC,
                        colocacionNC: filaPlazo.colocacionNC,
                ...
                $.post('/licitacion/saveCierre', datos, function(data){
                    if (data.id > 0){
                        $.redirect('/licitacion/cierre');
                    } else {
        ...
        var monedas = [
            ...
            { value: 'E', label: 'Especie'},
            { value: 'DL', label: 'Dolar Link'}
        ];
        ...
        $("#colocacionC").jqxNumberInput({ width: '300px', height: '20px', theme:theme, digits:6, decimalDigits: 0});
        $("#colocacionNC").jqxNumberInput({ width: '300px', height: '20px', theme:theme, digits:6, decimalDigits: 0});
        ...
        $("#editarPlazo").bind('click', function(){
            ...
            $("#colocacionC").val(fila.colocacionC);
            $("#colocacionNC").val(fila.colocacionNC);
...
//                { input: '#colocacionC', message: 'Debe ingresar el numero de colocación competitiva!',  rule: function(){
//                    return $("#colocacionC").val() > 30;
//                } },
//                { input: '#colocacionNC', message: 'Debe ingresar el numero de colocación no competitiva!',  rule: function(){
//                    return $("#colocacionNC").val() > 30;
//                } },
        ...
        $('#aceptarPlazo').bind('click', function () {
            ...
            if (plazo.formOK){
                ...
                var fila = {
                    ...
                    plazo: $("#plazo").val(),
                    especie: $("#especie").val(),
                    colocacionC: $("#colocacionC").val(),
                    colocacionNC: $("#colocacionNC").val(),
                    tituloC: $("#tituloC").val(),
