...
//        $("#colocacionDolares").jqxNumberInput({ width: '250px', height: '25px', theme:theme, digits:6, decimalDigits: 0});
        ...
        */
        ...
        if ($("#id").val() == 0){
            $("#titulo").text('Nuevo Cierre Treasuries');
        } else {
            $("#titulo").text('Editar Cierre Treasuries');
            datos = {
                cierretreasuries_id: $("#id").val()
            };
            $.post('/treasuries/getCierre', datos, function(data){
...
//                    colocacionDolares: $("#colocacionDolares").val()
                ...
                $.post('/treasuries/saveCierre', datos, function(data){
                    if (data.id > 0){
                        $.redirect('/treasuries/cierre');
                    } else {
