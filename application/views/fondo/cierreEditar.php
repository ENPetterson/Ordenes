...
//        $("#colocacionDolares").jqxNumberInput({ width: '250px', height: '25px', theme:theme, digits:6, decimalDigits: 0});
        ...
        */
        ...
        if ($("#id").val() == 0){
            $("#titulo").text('Nuevo Cierre Fondo');
        } else {
            $("#titulo").text('Editar Cierre Fondo');
            datos = {
                cierrefondo_id: $("#id").val()
            };
            $.post('/fondo/getCierre', datos, function(data){
...
//                    colocacionDolares: $("#colocacionDolares").val()
                ...
                $.post('/fondo/saveCierre', datos, function(data){
                    if (data.id > 0){
                        $.redirect('/fondo/cierre');
                    } else {
